//******************************************************************************
//
// File:    MandelbrotSetMethodSmp.java
//
...
/**
 * Class MandelbrotSetMethodSmp is an SMP parallel program that calculates the
 * Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.fractal.MandelbrotSetMethodSmp
 ...
 * @version 02-Nov-2007
 */
public class MandelbrotSetMethodSmp
        {

// Prevent construction.

        private MandelbrotSetMethodSmp()
                {
                }
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.fractal.MandelbrotSetMethodSmp <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
