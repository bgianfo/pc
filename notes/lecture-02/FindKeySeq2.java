...
// Unit:    Class edu.rit.smp.keysearch.FindKeySeq2
//
 ...
 * from the given plaintext. Whereas program {@linkplain FindKeySeq} always
 * tries all possible keys, program FindKeySeq2 stops as soon as it finds the
 * correct key.
 * <P>
 * Usage: java edu.rit.smp.keysearch.FindKeySeq2 <I>plaintext</I>
...
// Main program.
        ...
        public static void main
                ...
                for (int counter = 0;
                                counter <= maxcounter && foundkey == null;
                                ++ counter)
                        {
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java edu.rit.smp.keysearch.FindKeySeq2 <plaintext> <ciphertext> <partialkey> <n>");
