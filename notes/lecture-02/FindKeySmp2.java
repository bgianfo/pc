//******************************************************************************
//
// File:    FindKeySmp2.java
// Package: edu.rit.smp.keysearch
// Unit:    Class edu.rit.smp.keysearch.FindKeySmp2
//
 ...
 * from the given plaintext. Whereas program {@linkplain FindKeySmp} always
 * tries all possible keys, program FindKeySmp2 stops as soon as it finds the
 * correct key.
 * <P>
 * Usage: java [ -Dpj.nt=<I>K</I> ] edu.rit.smp.keysearch.FindKeySmp2
