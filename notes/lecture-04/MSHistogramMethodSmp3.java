//******************************************************************************
//
// File:    MSHistogramMethodSmp3.java
//
...
/**
 * Class MSHistogramMethodSmp3 is an SMP parallel program that calculates a histogram
 * of the Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.fractal.MSHistogramMethodSmp3 <I>width</I>
 ...
 * uses the reduction pattern with a shared reduction variable to accumulate the
 * histogram. The program uses a non-multiple-thread-safe data type for the
 * shared reduction variable along with a critical section to update the
 * reduction variable. The program measures the computation's running time,
 * including the time to print the output.
 *
 * @author  Alan Kaminsky
 * @version 02-Feb-2008
 */
public class MSHistogramMethodSmp3
        {

// Prevent construction.

        private MSHistogramMethodSmp3()
                {
                }
...
// Hidden operations.
        ...
        private static void computeRow(int r, int[] histogram)
                        {
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.fractal.MSHistogramMethodSmp3 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <outfile>");
