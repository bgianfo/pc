//******************************************************************************
//
// File:    MSHistogramMethodSmp2.java
//
...
/**
 * Class MSHistogramMethodSmp2 is an SMP parallel program that calculates a histogram
 * of the Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.fractal.MSHistogramMethodSmp2 <I>width</I>
 ...
 * histogram. The program measures the computation's running time, including the
 * time to print the output.
 *
 * @author  Alan Kaminsky
 * @version 02-Feb-2008
 */
public class MSHistogramMethodSmp2
        {

// Prevent construction.

        private MSHistogramMethodSmp2()
                {
                }
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.fractal.MSHistogramMethodSmp2 <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <outfile>");
