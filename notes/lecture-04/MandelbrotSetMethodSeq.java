//******************************************************************************
//
// File:    MandelbrotSetMethodSeq.java
//
...
/**
 * Class MandelbrotSetMethodSeq is a sequential program that calculates the Mandelbrot
 * Set.
 * <P>
 * Usage: java edu.rit.smp.fractal.MandelbrotSetMethodSeq <I>width</I> <I>height</I>
 ...
 * @version 02-Nov-2007
 */
public class MandelbrotSetMethodSeq
        {

// Prevent construction.

        private MandelbrotSetMethodSeq()
                {
                }
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java edu.rit.smp.fractal.MandelbrotSetMethodSeq <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
