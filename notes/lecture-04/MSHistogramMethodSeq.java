//******************************************************************************
//
// File:    MSHistogramMethodSeq.java
//
...
/**
 * Class MSHistogramMethodSeq is a sequential program that calculates a histogram of
 * the Mandelbrot Set.
 * <P>
 * Usage: java edu.rit.smp.fractal.MSHistogramMethodSeq <I>width</I> <I>height</I>
 * <I>xcenter</I> <I>ycenter</I> <I>resolution</I> <I>maxiter</I> <I>outfile</I>
 ...
 * output. This establishes a benchmark for measuring the computation's running
 * time on a parallel processor.
 *
 * @author  Alan Kaminsky
 * @version 02-Feb-2008
 */
public class MSHistogramMethodSeq
        {

// Prevent construction.

        private MSHistogramMethodSeq()
                {
                }
...
// Hidden operations.
        ...
        private static void computeRow(int r)
                        {
        ...
        private static void usage()
                {
                System.err.println ("Usage: java edu.rit.smp.fractal.MSHistogramMethodSeq <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <outfile>");
