//******************************************************************************
//
// File:    MSHistogramMethodSmp.java
//
...
/**
 * Class MSHistogramMethodSmp is an SMP parallel program that calculates a histogram
 * of the Mandelbrot Set.
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.fractal.MSHistogramMethodSmp <I>width</I>
 ...
 * @version 02-Feb-2008
 */
public class MSHistogramMethodSmp
        {

// Prevent construction.

        private MSHistogramMethodSmp()
                {
                }
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.fractal.MSHistogramMethodSmp <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <outfile>");
