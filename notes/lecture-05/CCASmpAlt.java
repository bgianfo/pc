...
/**
 * Class CCASmpAlt is an SMP parallel program that calculates the evolution of a
 ...
 * parallel by <I>K</I> threads, then the cell's current states are written as
 * one row of the image file by a single thread.
 * <P>
 * Usage: java [ -Dpj.nt=<I>K</I> ] edu.rit.smp.ca.CCASmpAlt <I>C</I> <I>S</I>
 ...
 * about the PJG format, see class {@linkplain edu.rit.image.PJGImage}.
 *
 * @author  Alan Kaminsky
 * @version 06-Jul-2009
 */
public class CCASmpAlt
        {
...
// Hidden operations.
        ...
        private static void usage()
                {
                System.err.println ("Usage: java [-Dpj.nt=<K>] edu.rit.smp.ca.CCASmpAlt <C> <S> <A> <B> <imagefile>");
