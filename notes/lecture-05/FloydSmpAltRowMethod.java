//******************************************************************************
//
// File:    FloydSmpAltRowMethod.java
//
...
/**
 * Class FloydSmpAltRowMethod is an SMP parallel program that uses Floyd's Algorithm to
 ...
 * </PRE>
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.network.FloydSmpAltRowMethod <I>infile</I>
 * <I>outfile</I>
 ...
 * required by class {@linkplain edu.rit.io.DoubleMatrixFile}.
 * <P>
 * The output file (<I>outfile</I>) is a binary file written in the format
 * required by class {@linkplain edu.rit.io.DoubleMatrixFile} containing the
 * distance matrix after running Floyd's Algorithm.
 * <P>
 * The computation is performed in parallel on multiple processors. The middle
 * loop over the distance matrix rows is a parallel loop. The program measures
 * the total running time (including I/O) and the computation's running time
 * (excluding I/O).
 *
 * @author  Alan Kaminsky
 * @version 09-Jan-2008
 */
public class FloydSmpAltRowMethod
        {

// Prevent construction.

        private FloydSmpAltRowMethod()
                {
                }
...
// Hidden operations.
        ...
        private static void computeRow(final int i, final double[] d_i, final int r, final double[] d_r) 
                {
                for (int c = 0; c < n; ++ c)
                        {
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.network.FloydSmpAltRowMethod <infile> <outfile>");
