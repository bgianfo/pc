//******************************************************************************
//
// File:    FloydSimpleRevSmpColMethod.java
//
...
/**
 * Class FloydSimpleRevSmpColMethod is an SMP parallel program that uses Floyd's Algorithm to
 ...
 * </PRE>
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.network.FloydSimpleRevSmpColMethod <I>infile</I>
 * <I>outfile</I>
 ...
 * loop over the distance matrix cols is a parallel loop. The program measures
 ...
 * @version 09-Jan-2008
 */
public class FloydSimpleRevSmpColMethod
        {

// Prevent construction.

        private FloydSimpleRevSmpColMethod()
                {
                }
...
// Hidden operations.
        ...
        private static void computeCol(final int i, final int c) 
                {
                for (int r = 0; r < n; ++ r)
                        {
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.network.FloydSimpleRevSmpColMethod <infile> <outfile>");
