//******************************************************************************
//
// File:    FloydSimpleSmpAltRowMethod.java
//
...
/**
 * Class FloydSimpleSmpAltRowMethod is an SMP parallel program that uses Floyd's Algorithm to
 ...
 * </PRE>
 * <P>
 * Usage: java -Dpj.nt=<I>K</I> edu.rit.smp.network.FloydSimpleSmpAltRowMethod <I>infile</I>
 * <I>outfile</I>
 ...
 * @version 09-Jan-2008
 */
public class FloydSimpleSmpAltRowMethod
        {

// Prevent construction.

        private FloydSimpleSmpAltRowMethod()
                {
                }
...
// Hidden operations.
        ...
        private static void computeRow(final int i, final int r) 
                {
                for (int c = 0; c < n; ++ c)
                        {
        ...
        private static void usage()
                {
                System.err.println ("Usage: java -Dpj.nt=<K> edu.rit.smp.network.FloydSimpleSmpAltRowMethod <infile> <outfile>");
