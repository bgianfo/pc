//******************************************************************************
//
// File:    MandelbrotSetClu2New.java
// Package: edu.rit.clu.fractal
// Unit:    Class edu.rit.clu.fractal.MandelbrotSetClu2New
//
...
/**
 * Class MandelbrotSetClu2New is a cluster parallel program that calculates the
 ...
 * edu.rit.clu.fractal.MandelbrotSetClu2New <I>width</I> <I>height</I>
 ...
 * @version 26-Dec-2009
 */
public class MandelbrotSetClu2New
	{

// Prevent construction.

	private MandelbrotSetClu2New()
		{
		}
...
// Main program.
	...
	public static void main
		...
		// Create image matrix to store results in master process.
		if (rank == 0)
			{
						...
						comm.send
							(mRank,
							 ...
							 IntegerBuf.rowSliceBuffer
								(slice, new Range (0, range.length()-1)));
						}
	...
	private static void usage()
		{
		System.err.println ("Usage: java -Dpj.np=<K> [-Dpj.schedule=<schedule>] edu.rit.clu.fractal.MandelbrotSetClu2New <width> <height> <xcenter> <ycenter> <resolution> <maxiter> <gamma> <filename>");
