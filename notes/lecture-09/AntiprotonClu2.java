//******************************************************************************
//
// File:    AntiprotonClu2.java
// Package: edu.rit.clu.antimatter
// Unit:    Class edu.rit.clu.antimatter.AntiprotonClu2
//
...
/**
 * Class AntiprotonClu2 is a cluster parallel program that calculates the
 ...
 * <P>
 * Usage: java -Dpj.np=<I>K</I> edu.rit.clu.antimatter.AntiprotonClu2
 ...
 * position array are passed from process to process in a pipelined fashion.
                ...
                for (int s = 0; s < snaps; ++ s)
                        ...
                        for (int t = 0; t < steps; ++ t)
                                ...
                                for (int k = 1; k < size; ++ k)
                                        ...
                                        world.sendReceive (predRank, outbuf, succRank, inbuf);
